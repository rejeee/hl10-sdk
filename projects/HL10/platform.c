...
bool DevUserInit(void)
{
...
#if USE_RTC_TIMER
    stc_rtc_cyccfg_t cycsel;
    /* PRD or PRDX */
    cycsel.rtcPrdsel = RtcPrds;
    cycsel.rtcPrds = Rtc1H;
    cycsel.rtcPrdx = 0xFF;
    ...
    if(gParam.rst.u8Por1_5V || gParam.rst.u8Por5V){
